...
const markallnotificationrequest=createAction("markallnotificationrequest")
const markallnotificationsuccess=createAction("markallnotificationsuccess")
const markallnotificationfail=createAction("markallnotificationfail")
const clearerror=createAction("clearerror")


const deleteallnotificationrequest=createAction("deleteallnotificationrequest")
const deleteallnotificationsuccess=createAction("deleteallnotificationsuccess")
const deleteallnotificationfail=createAction("deleteallnotificationfail")
...
const markallnotificationinitialstate={
        markallnotification:{}
}

export const markallnotificationreducer=createReducer(markallnotificationinitialstate,(builder)=>{
        builder.addCase(markallnotificationrequest,(state,action)=>{
                state.loading=true
                state.markallnotification={}
        })

        builder.addCase(markallnotificationsuccess,(state,action)=>{
                state.loading=false
                state.markallnotification=action.payload.success;
        })

        builder.addCase(markallnotificationfail,(state,action)=>{
                state.loading=false
                state.markallnotification={}
                state.error=action.payload
        })
...
const deleteallnotificationinitialstate={
        deletenotification:{}
}

export const deleteallnotificationreducer=createReducer(deleteallnotificationinitialstate,(builder)=>{
        builder.addCase(deleteallnotificationrequest,(state,action)=>{
                state.loading=true
                state.deletenotification={}
        })
        builder.addCase(deleteallnotificationsuccess,(state,action)=>{
                state.loading=false
                state.deletenotification=action.payload.success
        })
        builder.addCase(deleteallnotificationfail,(state,action)=>{
                state.loading=false
                state.deletenotification={}
                state.error=action.payload
        })
